    ...
    public static class JsonParser
    {
        ...
        public static JToken Parse(string text)
        {
            ...
            var ctx = new JsonParserContext(rd)
                .ConsumeWhiteSpace()
                .First(true, JsonParser.ConsumeObject, JsonParser.ConsumeArray);
            ...
            )
        {
            return ctx.First(
                ...
                JsonParser.ConsumeObject,
                JsonParser.ConsumeArray,
                JsonParser.ConsumeBoolean,
                JsonParser.ConsumeNull
                );
        }
